...
import Clothes_ABI from "./contract/Clothes_ABI.json";
...
//   const addClothes = async (id, name, price, quantity,tot) => {
//       const clothes = await contract.addClothes(id, name, price, quantity,tot=quantity*price);
//       await clothes.wait(); 
